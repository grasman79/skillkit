...
> **Source:** Vendored from [emilkowalski/skills](https://github.com/emilkowalski/skills) by Emil Kowalski (Sonner, Vaul; ex-Vercel, ex-Linear). MIT licensed. See `design/emil-kowalski/LICENSE`. Not authored by this project - reproduced with attribution.
