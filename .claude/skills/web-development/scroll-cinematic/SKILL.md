...
- This skill installed at `.claude/skills/web-development/scroll-cinematic/`.

### Step 0 — Ensure ffmpeg (run first, always)
Run `bash .claude/skills/web-development/scroll-cinematic/scripts/ensure-ffmpeg.sh`. It uses system ffmpeg if
